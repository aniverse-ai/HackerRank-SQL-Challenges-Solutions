...
earnings for any employee in the Employee table. Write a query to find the maximum total earnings for all employees as well
 as the total number of employees who have maximum total earnings. Then print these values as 2 space-separated integers. 

*/
SELECT (salary*months) as max_sal, COUNT(*) FROM employee
GROUP BY max_sal
ORDER BY max_sal DESC LIMIT 1;

SELECT (salary*months), COUNT(*) FROM employee
GROUP BY 1
ORDER BY 1 DESC LIMIT 1;
-- using MAX() is useless here 
-- -----------------------------------------------------------------------------------------------------------------------
/*
[] 
